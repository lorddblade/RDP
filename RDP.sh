...
printf "Wait..." >&2
{
sudo useradd -m Shiroi
sudo adduser Shiroi sudo
echo 'Shiroi:81926-HbT6' | sudo chpasswd
...
sudo adduser Shiroi chrome-remote-desktop
} &> /dev/null &&
printf "\nSetup Completed " >&2 ||
printf "\nError Occured " >&2
...
printf 'Your SUDO Pasword Is 81926-HbT6 \n'
